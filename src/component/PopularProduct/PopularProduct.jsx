        ...
        <div className='mt-5 px-2 md:px-0'>
            ...
            <div className='container mx-auto my-10'>
                ...
                <div className='flex justify-center mt-8'>
                    <button className={`bg-[#FFFFFF] shadow-5xl border-b-2 cursor-pointer hover:bg-[${Colors.primary}] px-2 hover:text-white transition-all duration-300 text-xl border-b-[#C14196] rounded-sm`}>
                        View All
                    </button>
