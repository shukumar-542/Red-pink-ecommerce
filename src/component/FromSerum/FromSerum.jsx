...
import prod1 from "../../assets/serum1.webp"
import prod2 from "../../assets/serum2.webp"
import prod3 from "../../assets/serum3.webp"
import prod4 from "../../assets/serum4.webp"
import prod5 from "../../assets/serum5.webp"
  ...
  return (
     <div className="container mx-auto mb-5 px-2 md:px-0">
            <div className="flex justify-between items-center">
                <p className={`text-md md:text-2xl font-medium border-b-2 border-[${Colors.secondary}]`}>Shop From <span className={`text-[${Colors.secondary}]`}>Serum</span></p>
