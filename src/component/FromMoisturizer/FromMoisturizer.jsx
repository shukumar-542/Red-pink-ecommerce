  ...
  return (
      <div className="container mx-auto mb-5 px-2 md:px-0">
            <div className="flex justify-between items-center">
                <p className={`text-md md:text-2xl font-medium border-b-2 border-[${Colors.secondary}]`}>Shop From <span className={`text-[${Colors.secondary}]`}>Moisturizer</span></p>
...
export default FromMoisturizer