...
import prod1 from "../../assets/toner1.webp"
import prod2 from "../../assets/toner2.webp"
import prod3 from "../../assets/toner3.webp"
import prod4 from "../../assets/toner4.webp"
import prod5 from "../../assets/toner5.jpg"
  ...
  return (
     <div className="container mx-auto mb-5 px-2 md:px-0">
            <div className="flex justify-between items-center">
                <p className={`text-md md:text-2xl font-medium border-b-2 border-[${Colors.secondary}]`}>Shop From <span className={`text-[${Colors.secondary}]`}>Toner</span></p>
